...
<table cellpadding="7" >
	...
	<tr><th>Parent:</th>
		...
		<td><img src="C:\Documents and Settings\A@z@m\My Documents\My Pictures\vlcsnap-46878.png" width="130" height="130" name="pick"/></td></tr>
...
<%	} %>
          ...
          <input name="discount" type="radio" value="Others"  checked />Others
           ...
           <td><b>Fee Amount:</b><br /><input name="feeamt" type="text"  size="10" maxlength="10" /></td>
