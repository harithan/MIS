...
<script src="scriptForDelete.js" type="text/javascript">
</script>
</head>
...
<form name="form1"  >
<center><h1>Delete</h1><hr /></center>
<table cellpadding="10" cellspacing="10" align="center"><tr><td>
<fieldset><legend><b>Student Details</b></legend>
<table cellpadding="7" >
	<tr><th>Roll No:</th>
		<td><input name="roll_num" id="roll_num" type="text" size="10" maxlength="10" onblur="getDetails()"/>
		</td>
		<th>Branch:</th>
	...
	<tr><th>Parent:</th>
		...
		<td><img src="C:\Documents and Settings\All Users\Documents\My Pictures\Sample Pictures\Sunset.jpg" width="130" height="130" name="pick"/></td></tr>
	...
	<tr><td>
           ...
           <center>
  				<input type="button" value="  view to delete  " onclick="fillTable()" id="getFocus"/> &nbsp;
