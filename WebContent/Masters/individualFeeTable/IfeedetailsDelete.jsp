...
try {
	sb.append("<table>");
	sb.append("<table align=\"center\" border=1><tr><th>ReceiptNo(Delete) </th><td>fee name</td><td>month</td><td>discount</td><td>amount</td></tr>");
	while(rs.next()){
		...
		String s="ifeeDeleteDest.jsp?roll_num="+roll_num+"&fee_name="+dfee_name+"&discount="+ddiscount+"&fee="+dfee+"&month="+ddate+"&rcno="+drcno;
		sb.append("<tr><td><a href="+s+">"+drcno+"</a></td><td>"+dfee_name+"</td><td>"+ddate+"</td><td>"+ddiscount+"</td><td>"+dfee+"</td></tr>");
