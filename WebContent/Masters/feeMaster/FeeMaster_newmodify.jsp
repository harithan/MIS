...
try {
    ...
    <input id="fee_schedule1" name="fee_sched" type="radio" value="Monthly"/>Monthly<br/>
    <input id="fee_schedule2" name="fee_sched" type="radio" value="Yearly"/>Yearly</fieldset>
  ...
  <tr>
    ...
    <input name="fee_admin" id="fee_for_admn_type2" type="radio" value="New Admission"/>New Admission
    <input name="fee_admin" id="fee_for_admn_type3" type="radio" value="Old Admission"/>Old  Admission</fieldset>
    </td>
    </tr>
      </table>
    </td>
  ...
  <tr>
    ...
    <input name="fees_type" id="fee_type1" type="radio" value="Bus Fee"/>Bus Fee
    <input name="fees_type" id="fee_type2" type="radio" value="Accomodation Fee"/>Accomodation Fee
    <input name="fees_type" id="fee_type3" type="radio" value="Others"/>Others
    </fieldset></td>
  </tr>
  <tr>
    <td>
   under group:<select name="under_group"><option value="CSE">CSE</option>
