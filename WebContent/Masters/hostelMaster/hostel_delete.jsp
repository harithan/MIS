...
<fieldset>
<legend><b>Delete Hostel Details</b></legend>
<br>
...
<table width="100%">
<tr>
<th><input type="reset" value=" Cancel "></th><th>
<input type="button" value="Delete" onclick="if(confirm('Are u sure?')) delHos();"/></th><th>
