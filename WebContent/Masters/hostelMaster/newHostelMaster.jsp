...
RequestDispatcher rd=request.getRequestDispatcher("./hostel_newmodify.jsp");
	        	...
	        	//st.executeUpdate("update Account set account_code='"+request.getParameter("accountcode")+"',bank_name='"+request.getParameter("bankname")+"',bank_address='"+request.getParameter("bankaddress")+"',account_number='"+request.getParameter("accnumber")+"' where hostel_name='"+hostel_name+"'");
	        	st.close();
	        		res.close();        	
	        	RequestDispatcher rd=request.getRequestDispatcher("./hostel_newmodify.jsp");
	        	rd.forward(request,response);
