		      	...
		      	<form name="form1">
							  		...
							  		<table>
							  			<tr>
							  				...
							  				<td><input type="text" name="course_name" id="course_name" onblur="viewCoursebyname()"  value='<%=request.getParameter("course_name")%>'></td>
							  			...
							  			<tr >
							  				...
							  				<td colspan="4"><input type="text" name="university_name" id="university_name" size="42"  value='<%=request.getParameter("university_name")%>'/>
							  				</td>
