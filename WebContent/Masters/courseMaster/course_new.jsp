...
<html>
  ...
  <legend><b>Enter the Course Details Here</b></legend>
   ...
   <table cellspacing="5" cellpadding="10">
    <tr>
		      <td width="70%">
		      	<form name="form1" action="./addCoursedet.jsp">
							  		...
							  		<table>
							  			<tr>
							  				...
							  				<td><input type="text" name="course_duration" id="course_duration" size="10"></td>
							  				<td><input type="submit" value="save " onclick="valCourse()"/></td>
							  			</tr>
							  			<tr >
