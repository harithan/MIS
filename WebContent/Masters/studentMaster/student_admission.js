...
function imageupload()
     {
     alert("hi");
     var sr=document.getElementById("file1").value;
     alert(sr);
     document.getElementById("ima2").src=sr;
     }
...
// function checking  year
  ...
  alert(dt);
	...
	{
	    alert("corrdate="+corrdate);
	    alert(corrdate.substring(0,2));
	    alert(corrdate.substring(3,5));
