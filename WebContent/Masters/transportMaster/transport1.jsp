...
<table width="456" height="122" border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <tr>
    <th scope="row" align="left" align="left">Area Name</th><td><input type="text" name="area_name" id="area_name" onblur="Validation1()" /></td>
  ...
  <tr>
    ...
    <td>
      <label>
        <input type="text" name="area_fee" id="area_fee" onkeypress="return isNumberKey(event)" onblur="fun()"/>
      </label>
   </td>
   <td><p id="xyz1"></p></td>
	</tr>
 ...
 <input type="reset" id="area_ cancel" value="&nbsp;&nbsp;cancel&nbsp;&nbsp;" onclick="getalll()" />
  ...
  <table width="601" border="0" cellspacing="2" cellpadding="2" align="center">
    <tr>
      ...
      <td width="4"><div id="bus_num_t" style="visibility: hidden;"><input type="text" name="bus_numt" id="bus_numt" size="10" /></div></td>
   ...
   try {
    ...
    <tr>
      ...
      <td>
        <input type="text" name="driver_mob" id="driver_mob" onkeypress="return isNumberKey(event)"/>
    ...
    <tr>
      ...
      <td><strong>Mobile:</strong></td>
      <td><label>
        <input type="text" name="faculty_mob" id="faculty_mob" onkeypress="return isNumberKey(event)"/>
    ...
    <tr>
      ...
      <td><strong>Mobile:</strong></td>
      <td><label>
        <input type="text" name="coordinator_mob" id="coordinator_mob" onkeypress="return isNumberKey(event)"/>
    ...
    <tr>
      ...
      <td><strong>Mobile:</strong></td>
      <td><label>
        <input type="text" name="incharge_mob" id="incharge_mob" onkeypress="return isNumberKey(event)" />
  ...
  <tr>
    ...
    <td><label>
      <input type="text" name="stage_name" id="stage_name" style="width:80%"/>
    </label></td>
  </tr>
 </table>
 <center>
...
<div class="TabbedPanelsContent"><form action="#" method="get" name="layout_master">
  ...
  <td><input id="layouttext" type="text" name="layout" style="visibility: hidden" > </td>
