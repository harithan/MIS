 ...
 <%
	try {
	        ...
	        if(!res.next()) {
	        	st.execute("insert into Account values('"+session.getAttribute("account_code")+"','"+request.getParameter("accname")+"','"+request.getParameter("bankname")+"','"+request.getParameter("bankaddress").trim()+"','"+request.getParameter("accnumber")+"')");
	        	response.sendRedirect("./accountmasternewmodify.jsp");      	
	        }
	        else {
	        	st.execute("delete from  Account where account_name='"+account_name+"'");
	        	st.execute("insert into Account values('"+request.getParameter("accountcode")+"','"+request.getParameter("accname")+"','"+request.getParameter("bankname")+"','"+request.getParameter("bankaddress").trim()+"','"+request.getParameter("accnumber")+"')");
