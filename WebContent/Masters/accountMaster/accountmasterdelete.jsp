...
<table border="1" align="center">
   <tr>
    ...
    <td><input type="text" name="accountcode" id="accountcode" onblur="viewAcc()" /></td>
   <td rowspan="5"><select name="acclist" size="18" style="width:100%" onclick="getAcc(this.value)">
   <%
	try {
