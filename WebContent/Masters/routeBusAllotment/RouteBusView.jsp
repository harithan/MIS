...
<table align="center">
<tr><th>Roll number:</th><td><input type="text" name="roll_num" id="roll_num" <%if(roll==null)
{}
else
{%>
	value="<%=roll%>"
...
<%if(roll==null||roll=="")
	...
	{%>
		...
		<tr><th bgcolor="skyblue">ROLLNUMBER</th><th bgcolor="skyblue">DATE</th><th bgcolor="skyblue">ROOT</th><th bgcolor="skyblue">BUSNUMBER</th></tr>
		<%try{
