...
function handleResponse(request)
{
  ...
  <body bgcolor="skyblue">   
		<center><h1>ADD / MODIFY</h1></center>
		<hr width="100%">		
		<%!Connection con = null;
	...
	{}
 	%>
		<form action="./student_hostel_modify.jsp" name="f1" onsubmit="return val()">
			<table cellpadding="10">
				<tr>
					<th align="left">
						HostelCode:
						<select name="hostelcode" style="width:100%">
					...
					<td rowspan="2">
						<img src="a.jpg" id="img" width="150" height="150" ></img>
					</td>
				</tr>
				<tr>
					<td>
  						<fieldset>
    						...
    						<table cellpadding="5">
    							<tr>
    								...
    								<td>
    									<input type="text" name="rollno" id="rollno" onblur="fun(this.value)"/>
    								</td>
    								<th align="left">
    									Branch: 
    								</th>
		...
		<center>
  			...
  			<div id="all_data" style="visibility:visible">
