...
sb.append("<tr><th width=80>AC Year/FEE NAME</th><th width=60>Paid</th><th width=60>Rec No/Dt</th><th width=60>Due</th><th width=60>Payable Fee</th></tr>");
try {
	int paidTotal=0;
	int origTotal=0;
	int dueTotal=0;
	...
	while(rs.next()){
		...
		sb.append("<tr><td width=80>"+fee_name+"</td><td width=60>"+paid+"</td><td width=60>("+reciept+")"+date+"</td><td width=60>"+due+"</td><td width=60>"+orig_amount+"</td></tr>");
		}
