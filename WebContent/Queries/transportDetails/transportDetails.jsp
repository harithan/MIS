			...
			<td><input type="button" value="View" onclick="getDetails()"></td><td></td><td></td>
				...
				<tr>
					...
					<table border=1 width="600">
						<tr>
							<th width="50">S.No.</th>
							<th width="130">Reg No.</th>
							<th width="150">Name</th>
							<th width="80">Branch</th>
							<th width="150">Reg Dt.</th>
							<th width="80">Paid Amt</th>
							<th width="150">Due Amt</th>
						</tr>		
					</table>
					<div style="position: absolute;width: 100%; margin: 20px 20 30px 0; height: 220px; overflow: auto; ">
...
<center><input type="button" value="PRINT" onclick="window.print()"> &nbsp;&nbsp;&nbsp; <input type="button" value="  QUIT  " onclick="window.close()">
</center>
