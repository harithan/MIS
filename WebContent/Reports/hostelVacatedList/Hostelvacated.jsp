...
<table>
<tr><td align="center">From Date:<input type="text" name="fromdate" id="fromdate" size="20"></td></tr>
<tr><td align="center">To Date:<input type="text" name="todate" id="todate" size="20"></td></tr>
