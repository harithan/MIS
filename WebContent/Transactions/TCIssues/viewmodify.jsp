...
<td>
<fieldset><table cellspacing="4">
<tr><td>Date On Which The<br/> Student Was Actually<br/> Left:</td><td><input type="text" name="leftdate" id="leftdate" size="10" value="<%=dateleave %>"></td><td rowspan="4"><img src="pass.jpg" height="140" width="110"></td></tr>
